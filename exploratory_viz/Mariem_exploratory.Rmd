...
### Comments:
Note that we would need to divide the # of immigrants for each governorate by its specific population in order to have a normalized and more fair way to compare each 
