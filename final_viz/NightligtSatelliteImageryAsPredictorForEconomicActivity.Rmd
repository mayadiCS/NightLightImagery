...
&s=NGDP_RPCH,PPPGDP,PPPPC,PCPIPCH,LUR,GGXWDG_NGDP&grp=0&a=
...
Note that we divided the consumption figure by a million, so the x-axis in this graph is consumption in thousands of Tunisian Dinars (TND). 
